  ...
  return (
    <section className="relative z-10 pt-12 pb-32 flex-grow container mx-auto px-4">
      ...
      {allPlans && allPlans?.length > 0 ? (
            ...
            <div className="flex flex-wrap gap-2">
              {allPlans.map((plan) => (
                ...
                >
                  {plan.name}
                  {plan.isActive && (
                    <span className="ml-2 bg-green-500/20 animate-pulse text-green-500 text-xs px-2 py-0.5 rounded">
                      ACTIVE
                    </span>
                  )}
                </Button>
       ...
       <span className="text-5xl text-secondary/50 font-bold">No Fitness Plan</span> 
        // <NoFitnessPlan />
      )}
